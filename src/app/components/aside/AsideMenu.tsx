...
export const AsideMenu: React.FC<AsideProps> = ({ indexes, handleIndexes }) => {
    ...
    return (
        <div className={`border-hover-aside flex flex-col justify-between items-center text-[15px] md:text-[25px] text-[var(--color-3)] rounded-xl rounded-r-none`}>
            <div>
                <motion.ul layout className="h-full justify-center items-center inline-flex flex-col gap-3 p-2 pt-4 md:p-5">
