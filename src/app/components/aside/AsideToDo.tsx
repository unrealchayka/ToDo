...
const AsideToDoMenu = ({ title, icon, color, items, indexKey }: FiltersDictionary)=>{
    ...
    return(
        <div key={title} className="px-5 pt-2">
...
export const AsideToDo = () => {
    ...
    return (
        <motion.div className={`z-1 text-[13px] sm:border-r-2 ${borderColor} bg-[var(--color-1)] duration-1000 sm:text-[18px] whitespace-nowrap flex flex-col pt-10 gap-2 3xl:gap-8 w-full h-full`}>
